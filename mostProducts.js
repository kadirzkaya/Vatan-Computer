import bestSeller from './bestSeller.json' assert {type: 'json'};

function showProductMost(data){
    for (let i = 0; i < data.length; i++) {

        let script=`<div class="card h-100 text-center">
        ...
        $('.most-products .carousel-most').owlCarousel('add', script).owlCarousel('update');
            
    }

}

showProductMost(bestSeller);